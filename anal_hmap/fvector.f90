...
!*******************************
    ...
    real*8 function phi_pd( r ) 
        ...
        phi_pd = phi_pdu(r)+2*fpdup0*rhoa_pd(r)
    end function phi_pd
    ...
    real*8 function phi_h( r ) 
        ...
        phi_h = D_hh*(beta_hh*exp(-alpha_hh*(r-r0_hh))-alpha_hh*exp(-beta_hh*(r-r0_hh)))
    end function phi_h
    ...
    real*8 function phi_pdh( r ) 
        ...
        phi_pdh = D_pdh*(beta_pdh*exp(-alpha_pdh*(r-r0_pdh))-alpha_pdh*exp(-beta_pdh*(r-r0_pdh)))
